...
class Employee:
    @staticmethod
    def create(code, first_name, last_name, national_id, address, phone_number, age, email, password, role='librarian'):
        cur = mysql.connection.cursor()
        try:
            cur.execute("""
                INSERT INTO employees (
                    code, first_name, last_name, national_id, address, 
                    phone_number, age, email, password, role
                ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
            """, (code, first_name, last_name, national_id, address, phone_number, 
                  age, email, password, role))
    ...
    @staticmethod
    def update(id_employee, first_name, last_name, national_id, address, phone_number, age, email, role):
        cur = mysql.connection.cursor()
        try:
            cur.execute("""
                UPDATE employees 
                SET first_name = %s, last_name = %s, national_id = %s, 
                    address = %s, phone_number = %s, age = %s, 
                    email = %s, role = %s
                WHERE id_employee = %s
            """, (first_name, last_name, national_id, address, phone_number, 
                  age, email, role, id_employee))
            mysql.connection.commit()
